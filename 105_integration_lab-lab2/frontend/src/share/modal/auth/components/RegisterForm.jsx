...
const RegisterForm = ({ setIsLogin = () => {} }) => {
  ...
  if(error.response)
  return setStatus({msg: error.response.data.error,severity: 'error',});
  return setStatus({msg: error.message,severity: 'error',});},});

  const handleSubmit = () => {
    if(!validateForm()) return;registerMutation.mutate();
  };
